...
function TokenSignIn({ token }: { token: string }) {
  ...
  if (status === "error") {
    return (
      <div style={{ textAlign: "center", color: "#94a3b8", padding: "40px 0" }}>
        ...
        <p style={{ marginBottom: 16 }}>This sign-in link has expired or already been used.</p>
  ...
  return (
    <div style={{ textAlign: "center", color: "#94a3b8", padding: "40px 0" }}>
      <div style={{ marginBottom: 12, fontSize: 14 }}>Signing you in…</div>
      <div style={{
            ...
            appearance={{
              elements: {
                ...
                socialButtonsBlockButton:
                  "bg-[#121c2e] border border-[rgba(255,255,255,0.08)] text-white",
                formFieldInput:
