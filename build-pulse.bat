...
set /p SUPA_SERVICE="  -> Supabase SERVICE ROLE key: "
...
set /p RESEND_FROM="  -> From email (e.g. reports@yourdomain.com): "

:: ── Inngest ────────────────────────────────────────────────────────────────
echo.
echo  +---------------------------------------------------------+
echo  ^|  INNGEST (Background jobs / scheduled reports)          ^|
echo  ^|                                                         ^|
echo  ^|  1. Go to https://app.inngest.com                      ^|
echo  ^|  2. Manage -^> Event Keys and Signing Key               ^|
echo  +---------------------------------------------------------+
echo.
start "" "https://app.inngest.com"
set /p INNGEST_EVENT="  -> Inngest Event Key: "
set /p INNGEST_SIGN="  -> Inngest Signing Key: "
