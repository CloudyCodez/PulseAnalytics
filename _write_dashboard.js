...
var page = [
  ...
  '            {m.delta ? <span style={{ fontSize: 12, fontWeight: 600, color: "#00e5cc" }}>{m.delta}</span> : null}',
  ...
  '          {["Acme Co - Week of Jun 9","BlueSky Agency - Week of Jun 9","TechFlow Inc - Week of Jun 2"].map(function(r) { return (',
...
fs.writeFileSync(path.join(dashDir, 'page.tsx'), page);
console.log('done');
